        ...
        <div className="container">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {[
              ...
              <div key={label} className="flex items-center gap-3 p-4 rounded-2xl bg-white/[0.03]">
      ...
      <section className="py-20">
        <div className="container">
          <div className="text-center mb-12 reveal">
            ...
            <p className="text-slate-400 max-w-xl mx-auto">Select a category below or email us directly — we support all 77 apps across iOS and Android.</p>
          </div>
        ...
        <div className="container">
          <div className="max-w-3xl mx-auto">
            <div className="text-center mb-12 reveal">
              ...
              <p className="text-slate-400">Quick answers to the most common support questions.</p>
            </div>
        ...
        <div className="container">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12 reveal">
              ...
              <p className="text-slate-400">Our team is available across both offices. Reach out and we'll get back to you promptly.</p>
            </div>

            <div className="grid md:grid-cols-2 gap-6 reveal">
              {/* USA Office */}
              <div className="p-8 rounded-3xl border border-white/10 bg-white/[0.05]"
                style={{ boxShadow: "0 8px 40px oklch(0.52 0.22 270 / 0.06)" }}>
                <div className="flex items-center gap-3 mb-6">
                  <span className="text-3xl">🇺🇸</span>
                  <div>
                    <div className="font-bold text-white">American Group LLC</div>
                    <div className="text-xs text-slate-400">Santa Clara, California, USA</div>
                  </div>
                </div>
                <div className="space-y-3">
                  <a href={`mailto:${SUPPORT_EMAIL}`}
                    ...
                    <span className="text-sm text-slate-200 group-hover:text-indigo-700">{SUPPORT_EMAIL}</span>
                  </a>
                  <a href={`tel:+15104589059`}
                    className="flex items-center gap-3 p-3 rounded-xl bg-white/[0.03] hover:bg-indigo-500/10 transition-colors group">
                    <Phone className="h-4 w-4 text-indigo-500 shrink-0" />
                    <span className="text-sm text-slate-200 group-hover:text-indigo-700">{USA_PHONE}</span>
                  </a>
                  <div className="flex items-center gap-3 p-3 rounded-xl bg-white/[0.03]">
                    <Clock className="h-4 w-4 text-slate-400 shrink-0" />
                    <span className="text-sm text-slate-400">Mon–Fri, 9 AM–5 PM PST</span>
                  </div>
                </div>
              </div>
              ...
              <div className="p-8 rounded-3xl border border-white/10 bg-white/[0.05]"
                ...
                <div className="flex items-center gap-3 mb-6">
                  <span className="text-3xl">🇮🇳</span>
                  <div>
                    <div className="font-bold text-white">SafeCodeX Research Center</div>
                ...
                <div className="space-y-3">
                  <a href={`mailto:${SUPPORT_EMAIL}`}
                    ...
                    <span className="text-sm text-slate-200 group-hover:text-amber-700">{SUPPORT_EMAIL}</span>
                  </a>
                  <a href={`tel:+917416866689`}
                    className="flex items-center gap-3 p-3 rounded-xl bg-white/[0.03] hover:bg-amber-500/10 transition-colors group">
                    <Phone className="h-4 w-4 text-amber-500 shrink-0" />
                    <span className="text-sm text-slate-200 group-hover:text-amber-700">{INDIA_PHONE}</span>
                  </a>
                  <div className="flex items-center gap-3 p-3 rounded-xl bg-white/[0.03]">
                    <Clock className="h-4 w-4 text-slate-400 shrink-0" />
                    <span className="text-sm text-slate-400">Mon–Fri, 9 AM–6 PM IST</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="mt-8 p-6 rounded-2xl bg-white/[0.03] reveal">
              <div className="text-sm font-semibold text-slate-200 mb-4">Related Pages</div>
