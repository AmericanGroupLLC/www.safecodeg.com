...
import { ArrowRight, Code2, Brain, Shield, Globe, Zap, Users, CheckCircle, MapPin, ChevronRight, Cpu, Smartphone } from "lucide-react";
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-10">
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
            ...
            <div className="flex items-center gap-2 text-slate-500 text-xs font-mono mb-6">
              <Link href="/" className="hover:text-white transition-colors">American Group LLC</Link>
            ...
            <p className="text-xl text-slate-300 max-w-3xl leading-relaxed mb-4">
              The India engineering office of <strong className="text-white">American Group LLC</strong> — our R&D powerhouse delivering world-class software outsourcing, frontier AI research, and engineering excellence from Hyderabad.
            </p>
            <p className="text-slate-500 text-base max-w-2xl mb-10">
              SafeCodeX Research Center Pvt. Ltd. operates under the direction of American Group LLC, providing QA, backend delivery, embedded firmware research, and mobile development support.
            </p>
            <div className="flex flex-wrap gap-4">
              <Link href="/contact">
                <button className="flex items-center gap-2 px-7 py-3.5 rounded-xl font-bold text-white transition-all duration-300 hover:scale-105" style={{ background: "linear-gradient(135deg, #F59E0B, #D97706)", boxShadow: "0 0 30px rgba(245,158,11,0.3)" }}>
      ...
      <section className="py-16 border-y border-white/5">
        <div className="max-w-7xl mx-auto px-6 lg:px-10">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              { value: "10%", label: "of AGL Delivery Pipeline", color: "#FBBF24" },
              ...
              return (
                ...
                >
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <h3 className="font-bold text-white text-sm" style={{ fontFamily: "Sora, sans-serif" }}>{svc.title}</h3>
                  </div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.7 }}>
              ...
              <p className="text-slate-400 leading-relaxed mb-8">
                SafeCodeX Research Center combines India's world-class engineering talent with the product vision and market access of American Group LLC. The result is a delivery organization that operates at the quality bar of Silicon Valley with the scale and depth of India's best engineering teams.
              </p>
        ...
        <div className="relative z-10 max-w-3xl mx-auto px-6 text-center">
          <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.7 }}>
            <h2 className="font-black text-white mb-5 tracking-tight" style={{ fontFamily: "Sora, sans-serif", fontSize: "clamp(2rem, 4vw, 3.5rem)" }}>
              Ready to work with<br />SafeCodeX?
            </h2>
            <p className="text-slate-400 text-lg mb-10">
              Whether you need software outsourcing, AI research, or engineering talent — we're ready to deliver.
            </p>
            <div className="flex flex-wrap gap-4 justify-center">
              <Link href="/contact">
                <button className="flex items-center gap-2 px-8 py-4 rounded-xl font-bold text-white transition-all duration-300 hover:scale-105" style={{ background: "linear-gradient(135deg, #F59E0B, #D97706)", boxShadow: "0 0 40px rgba(245,158,11,0.25)" }}>
